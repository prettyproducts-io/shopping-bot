...
namespace ShoppingBot\Admin;

/**
 * ShoppingBot Setup Class
 */
class Setup {
	/**
	 * Constructor.
	...
	public function register_scripts() {
		...
		wp_enqueue_script( 'shopping-bot' );
		wp_enqueue_style( 'shopping-bot' );
	}
	...
	public function register_page() {
		...
		wc_admin_register_page(
			array(
				'id'     => 'shopping_bot-example-page',
				'title'  => __( 'Shopping Bot', 'shopping_bot' ),
				'parent' => 'woocommerce',
				'path'   => '/shopping-bot',
			)
		);
